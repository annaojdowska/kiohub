...
public class MailController {
    ...
    @RequestMapping(method = RequestMethod.GET, value = "/sendinvitation", params = {"topic"}) 
    public ResponseEntity<String> sendinvitation(
            @RequestParam("topic") String topic
    ) {
 
        List<String> recipients = new ArrayList<String>();
        recipients.add("kiohub2018@gmail.com");
        ...
        return new ResponseEntity<String>("Poszlo dobrze", HttpStatus.OK);       
    }
}
